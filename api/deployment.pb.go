...
type DeploymentRestartResp struct {
...
func (x *DeploymentRestartResp) Reset() {
	*x = DeploymentRestartResp{}
...
func (x *DeploymentRestartResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeploymentRestartResp) ProtoMessage() {}

func (x *DeploymentRestartResp) ProtoReflect() protoreflect.Message {
	mi := &file_deployment_proto_msgTypes[0]
...
// Deprecated: Use DeploymentRestartResp.ProtoReflect.Descriptor instead.
func (*DeploymentRestartResp) Descriptor() ([]byte, []int) {
	return file_deployment_proto_rawDescGZIP(), []int{0}
}

func (x *DeploymentRestartResp) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
var file_deployment_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x2f, 0x0a, 0x15, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74,
	0x52, 0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x16, 0x0a, 0x06, 0x73,
...
var file_deployment_proto_goTypes = []interface{}{
	(*DeploymentRestartResp)(nil), // 0: DeploymentRestartResp
}
...
func file_deployment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_deployment_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeploymentRestartResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
